...
const NotificationCard = ({ data, index, notificationState }) => {
  ...
  return (
    <div
      className={
        "p-6 border border-grey bg-grey m-2 rounded-md" +
        (!seen ? "border-l-4 border-l-black" : "")
      }
    >
      ...
      <div className="ml-14 pl-5 mt-3 text-dark-grey flex gap-8">
        <p className=" text-gray-400">{getDay(createdAt)}</p>
        {type !== "like" ? (
          <>
            {!reply ? (
              <button
                className="underline hover:text-black text-gray-400"
      ...
      {reply ? (
        <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
            ...
            <div>
              <h1 className="font-medium text-xl text-dark-grey">
                <Link
                  ...
                  className="mn-1 text-black underline"
                >
                  {author_username}
                </Link>
          ...
          <button
            className="hover:text-black ml-14 mt-2  text-gray-400"
