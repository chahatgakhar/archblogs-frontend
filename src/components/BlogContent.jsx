...
const BlogContent = ({ block }) => {
  ...
  if (type == "image") {
    return <BlogImg url={data.file.url} caption={data.caption} />;
  }
  ...
  if (type == "list") {
    return <BlogList style={data.style} items={data.items} />;
  } else {
    return <h1>Block</h1>;
  }
};
